...
namespace TESTING{
    public class CMD_DatabaseExtension_Examples : CMD_DatabaseExtension 
    {
        new public static void Extend(CommandDatabase database)
        {
            ...
            database.AddCommand("process_mp", new Func<string[], IEnumerator>(MutiLineProcess));
        ...
        private static IEnumerator MutiLineProcess(string[] data)
        {
        ...
        private static IEnumerator MoveCharacter(string direction)
        {
            ...
            Transform character = GameObject.Find("TestChar").transform;
            float moveSpeed = 15;
