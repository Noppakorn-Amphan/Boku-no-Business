...
public class TextArchitect
{
    ...
    public enum BuildMettod { instant, typewritter, fade}
    public BuildMettod buildMettod = BuildMettod.typewritter;
    ...
    /// Append text to what is alredy in the text architect.
    ...
    IEnumerator Building()
    {
        ...
        switch(buildMettod)
        {
            case BuildMettod.typewritter:
                yield return Build_Typewriter();
                break;
            case BuildMettod.fade:
