...
public class AudioChannel
{
    ...
    public AudioTrack PlayTrack(AudioClip clip, string filePath, bool loop, float startingVolume, float volumeCap, float pitch)
    {
        ...
        AudioTrack track = new AudioTrack(clip, filePath, loop, startingVolume, volumeCap, pitch, this, AudioManager.instance.musicMixer);
        track.Play();
