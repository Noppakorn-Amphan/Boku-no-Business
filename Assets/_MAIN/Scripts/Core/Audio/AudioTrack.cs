...
public class AudioTrack
{
    ...
    public AudioTrack(AudioClip clip, string filePath, bool loop, float startingVolume, float volumeCap, float pitch, AudioChannel channel, AudioMixerGroup mixer)
    {
        name = clip.name;
        path = filePath;
